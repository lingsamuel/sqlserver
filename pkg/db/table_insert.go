...
var _ sql.InsertableTable = (*ProxyTable)(nil)
var _ sql.RowInserter = (*tableEditor)(nil)

func (t *ProxyTable) Inserter(*sql.Context) sql.RowInserter {
...
func (t *ProxyTable) Insert(ctx *sql.Context, row sql.Row) error {
